...
<script>
    ...
    beforeMount(){
      ...
      { label:'业务单号',prop:'busiBillNo',width:'160px' },
      { label:'货主',prop:'ownerName',width:'180px'},
      { label:'制单人',prop:'busiBillCreater',width:'180px'},
      { label:'计划入库仓库',prop:'planWarehouseName',width:'180px'},
      { label:'制定时间',prop:'busiBillCreaterTime',formatter:this.formatter(1,'time'),width:'160px'},
      { label:'计划入库日期',prop:'planTime',formatter:this.formatter(1,'time'),width:'160px'},
