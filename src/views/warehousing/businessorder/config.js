...
export const indexTableConfig=[
  { label:'业务单号',fixed:true,prop:'billNo',width:150,linkTo:'/warehousing/businessorder-detail',query:[{key:'id',value:'id'}] },
  ...
  { label:'已计划入库数量',prop:'planInQty',width:180},
