      ...
      <el-row>
          <el-col :sm="12" :md="8" :lg="8" :xl="6">
            <el-form-item label="调整类型" >
              <el-select  v-model="searchForm.improveReason" clearable  placeholder="请选择调整类型：" size="mini" class="formitem">
          ...
          <el-col :sm="12" :md="8" :lg="8" :xl="6">
            <el-form-item label="业务单号:">
              <el-input v-model="searchForm.billNo" placeholder="请输入业务单号" size="mini" class="formitem"></el-input>
            </el-form-item>
          </el-col>

          <el-col :sm="12" :md="8" :lg="8" :xl="6">
            <el-form-item label="调整人:">
              <el-input v-model="searchForm.createrName" placeholder="请输入调整人" size="mini" class="formitem"></el-input>
            </el-form-item>
          </el-col>
