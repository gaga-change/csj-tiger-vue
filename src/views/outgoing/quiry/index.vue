...
<script>
    ...
    beforeMount(){
      this.tableConfig=[
        { label:'出库单号',prop:'warehouseExeCode',width:'180px',fixed:true,formatter:this.formatter(1,'linkTo')},
        ...
        { label:'是否越库',prop:'isCross',width:'150px',formatter:this.formatter(1,'Boolean')},
        { label:'出库日期',prop:'outStoreTime',formatter:this.formatter(1,'time'),width:'160px'},
