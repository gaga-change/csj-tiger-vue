<template>
  <div class="OutgoingPlanListinvoice outgoing-quirydetail-container">
    ...
    <div style="display:flex">
      <div style="flex:1;display:flex;flex-wrap:wrap;">
        ...
        <span class="f12 mr20 mt10 nowrap">
          <span class="fw600 mr5">客户名称 :</span>
          <span>{{data.arrivalName}}</span>
        </span>
        <span class="f12 mr20 mt10 nowrap">
          <span class="fw600 mr5">联系电话 :</span>
          <span>{{data.arrivalLinkTel}}</span>
        </span>
        <span class="f12 mr20 mt10 nowrap">
          <span class="fw600 mr5">通知单号 :</span>
          <span>{{data.busiBillNo}}</span>
        </span>
        <span class="f12 mr20 mt10 nowrap">
          <span class="fw600 mr5">客户地址 :</span>
          <span>{{data.arrivalAddress}}</span>
        </span>
      </div>
