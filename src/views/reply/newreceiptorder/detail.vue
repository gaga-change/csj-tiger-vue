  ...
  <div>
    ...
    <template v-if="fetchSuccess">
      <template v-if="approveStatus == 2">
        <el-button  style="margin-left: 10px;"  size="mini"  type="warning" @click="Prompt('delete')" >删除</el-button>
        <el-button  style="margin-left: 10px;"  size="mini"  type="primary" @click="Edit" >修改</el-button>
      </template>
      <template v-else-if="approveStatus == 0">
        <el-button  style="margin-left: 10px;"   size="mini" type="primary"   @click="Prompt('examine')" >审核</el-button>
        <el-button  style="margin-left: 10px;"   size="mini"  type="error"  @click="Prompt('reject')"  >驳回</el-button>
      </template>
      <template v-else>
