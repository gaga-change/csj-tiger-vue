  ...
  <div class="carrier">
    ...
    >
      <add-search
        @submit="submit"
        :searchForm="addForm"
        @handleClose="()=>this.handleClose('addform')"
      ></add-search>
    </el-dialog>
    ...
    >
      <div class="relationDialog">
        ...
        >
          ...
          >
            <el-select
              v-model="ownerListForm.ownerList"
              multiple
              filterable
              placeholder="请选择需要关联的货主"
              style="width:400px"
            >
              <el-option
    ...
    >
      ...
      >
        <add-address-search
          :searchForm="addAddressSearchForm"
          @submit="submit"
          @handleClose="handleClose('addAddress')"
        />
      </el-dialog>
    </el-dialog>
