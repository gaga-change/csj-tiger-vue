        ...
        <el-row>
            ...
            <el-col :sm="12" :md="8" :lg="8" :xl="6">
              <el-form-item label="客户:">
                <el-input v-model="searchForm.客户" placeholder="请输入供应商" size="small" class="formitem"></el-input>
              </el-form-item>
            </el-col>
         ...
         <el-tabs v-model="activeName">
            <el-tab-pane label="商品明细" name="Inventory">
              <div class="revisalEditTable">
                 <edit-Table
                  ...
                  :loading="loading"
                  :config="outgoing_carrierDetailConfig" 
            ...
            <el-tab-pane label="订正记录" name="records">
              <web-pagination-table 
               :loading="loading"
               :config="outgoing_carrierrecordsConfig" 
