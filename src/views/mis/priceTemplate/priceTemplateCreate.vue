<template>
  <div>
    <el-form :model="form" :rules="rules" :inline="true" ref="form" label-width="95px">
      <el-form-item label="费用模板名称" prop="templateName">
        <el-input v-model="form.templateName" style="width:200px"></el-input>
      </el-form-item>
        ...
        <el-table :data="tableData" border max-height="300" style="width:100%">
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button type="text" @click="sureDel(scope.row, scope.$index)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </template>
        ...
        <div class="weightcard">
          <span class="fr">
            <upload-excel 
              ...
              type="text"
            ></upload-excel>
            <a href="/static/templet/pricetempV.xlsx"><el-button type="text">下载模板</el-button></a>
          </span>
        </div>
        <el-table :data="tableData" border max-height="300" style="width:100%">
          <el-table-column
      ...
      <el-row>        
        <el-button type="primary" @click="savePriceTemplet" :disabled="loading" v-loading="loading">保存</el-button>
