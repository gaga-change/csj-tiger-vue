          ...
          <el-row>
              ...
              <el-col>
                <el-form-item label="WMS:" prop="warehouseSysCode" :rules="[{ required: true, message: '该项为必填'}]" >
                  <el-select  v-model="searchForm.warehouseSysCode" clearable  placeholder="请选择WMS系统" size="mini" class="formitem">
              ...
              <el-col>
                <el-form-item label="仓库类型:" prop="warehouseType" :rules="[{ required: true, message: '该项为必填'}]" >
                  <el-select  v-model="searchForm.warehouseType" clearable  placeholder="请选择仓库类型" size="mini" class="formitem">
              ...
              <el-col>
                <el-form-item label="接收人:" prop="warehouseLinkName">
                  <el-input v-model="searchForm.warehouseLinkName" placeholder="请输入接收人" size="mini" class="formitem"></el-input>
                </el-form-item>
              </el-col>
              ...
              <el-col>
                <el-form-item label="详细地址:" prop="warehouseAddress">
                  <el-input v-model="searchForm.warehouseAddress" placeholder="请输入详细地址" size="mini" class="formitem"></el-input>
                </el-form-item>
              </el-col>
              <el-col>
                <el-form-item label="联系方式:" prop="linkTel" :rules="[{ required: false, message:'请输入正确格式的手机号',pattern:/^1[34578]\d{9}$/ }]">
                  <el-input v-model="searchForm.linkTel" placeholder="请输入联系方式" size="mini" class="formitem"></el-input>
                </el-form-item>
              </el-col>
          </el-row>
        </el-form>
