  ...
  export  const baseInfoConfig=[ //基本信息
    { title:'采购订单号',prop:'ticketno',},
    { title:'计划到货日期',prop:'planarrivedate',type:'time'},
    { title:'收货人电话',prop:'linktel',},
    { title:'收货人',prop:'linkusername',},
    { title:'交货方式',prop:'deliverway',useLocalEnum:true,type:'deliverwayConfig'},
    { title:'供应商',prop:'servicername',},
    { title:'付款方式',prop:'paymethod',useLocalEnum:true,type:'paymethodConfig'},
    { title:'到达仓库',prop:'revstorename',},
    { title:'来源计划单号',prop:'enquiryorder',},
    { title:'交货地址',prop:'receiveaddress',},
    { title:'合同编号',prop:'contractno',},
    { title:'订单日期',prop:'orderdate',},
    { title:'采购负责人',prop:'leader',},
  ...
  export  const tabbelConfig=[ //表格
    ...
    {label:'供应商商品编码',prop:'custommaterialno',},
    {label:'商品名称',prop:'materialname',},
    {label:'品牌',prop:'materialtag',},
    {label:'规格',prop:'materialrule',},
    {label:'数量',prop:'ordernum',},
    {label:'单位',prop:'orderunit',},
    {label:'采购单价',prop:'orderprice',},
    {label:'采购金额',prop:'orderamount',},
