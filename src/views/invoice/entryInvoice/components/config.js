...
export  const listIndexConfig=[
  { label:'收票单号',prop:'finaPurchaseInvoiceId',width:150,linkTo:'/invoice/entryInvoice/registrationDetail',query:[{key:'finaPurchaseInvoiceId',value:'finaPurchaseInvoiceId'}]},
  ...
  { label:'操作',linkTo:'/invoice/entryInvoice/registrationDetail',query:[{key:'finaPurchaseInvoiceId',value:'finaPurchaseInvoiceId'}],linkText:'查看'},
]
