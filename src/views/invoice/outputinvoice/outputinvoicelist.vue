  ...
  created() {
    ...
    if (!this.gridData.length) {
     ...
     this.tableConfig=[
      ...
      { label:'计划开票金额',prop:'planinvoiceamount',width:'150px'},
      { label:'计划开票数量',prop:'planinvoicenum',width:'150px'},
       { label:'发票类型',prop:'invoicetype',width:'150px',dom:this.formatter('invoicetypeFilter')},
      { label:'状态',prop:'status',width:'150px',dom:this.formatter('statusFilter')},
