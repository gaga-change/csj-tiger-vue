<template>
  <div class="outgoing-quiry-container">
    ...
    <div class="operationitem">
      <router-link :to="`/otherOrder/requisitionplanForm?type=add&time=${moment().valueOf()}`">
        <el-button
          type="primary"
          size="mini"
        >新建调度单</el-button>
        ...
        <template slot-scope="scope">
          <div class="tableLinkBox">
            ...
            <!-- <router-link
              ...
              :to="`/otherOrder/requisitionplanForm?type=modify&id=${scope.row.id}&time=${moment().valueOf()}`"
              class="tableLink"
            >修改</router-link> -->
            <!-- <span
              v-if="[0].includes(scope.row.transferStatus)"
